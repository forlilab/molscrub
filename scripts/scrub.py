...
acidbase.add_argument("--pka_model", default="rules", choices=["rules", "etr1"],
                      help="method to calculate pka: [\"rules\" (default),\"etr1\"].\n" + 
...
geom.add_argument("--num_internal_confs", help="Number of initial conformers generated by ETKDG (default=3). \nNote that this does not change the number of molecules produced.", type=int, default=3)
geom.add_argument("--min_output_confs", help="Minimum number of output conformers for each protonation/tautomeric state", type=int, default=1)
...
# if pka model is used, the default pka file must be used. 
...
scrub = Scrub(
    ...
    num_internal_confs=args.num_internal_confs,
    min_output_confs=args.min_output_confs,
